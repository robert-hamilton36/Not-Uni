  ...
  return knex('modules').del()
    .then(function () {
      ...
      return knex('modules').insert([
        ...
        { id: 103, title: 'The Language of C# (CSharp)', user_id: 10003, category: 'Csharp', duration: 15, description: "C# (CSharp) - Because C Wasn't Easy Enough", number_of_elements: 5 },
