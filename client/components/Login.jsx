...
import { signIn, signInWithOutsideProvider, google } from '../actions/authenticated'
...
class Login extends React.Component {
  ...
  handleGoogle = async (event) => {
    event.preventDefault()
    try{
      await this.props.dispatch(signInWithOutsideProvider(google))
    }catch {
      return "Failed to login"
    }
  }
    ...
    return (
      <div className='login-card'>
        ...
        <div> 
          ...
          <span><button onClick={this.handleGoogle}>Continue with Google</button> </span>
        </div> 
      </div>
    )
  }
